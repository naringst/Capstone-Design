  ...
  return (
    <div className=" bg-gray-100 ">
      ...
      <section className="md:px-40 p-10 md:py-20 ibm place-items-center">
        ...
        <div className="ibm md:text-sm text-xs bg-white rounded-lg p-2 mt-3 ">
          <h1 className="p-3 mb-2 text-center">
            토스 계정을 잠시 잠그고 싶어요
          </h1>
        </div>
        <div className="md:flex md:text-sm text-xs mx-auto place-content-stretch text-center">
          <div className="bg-white px-10 py-5 mx-auto mt-1 rounded-lg ">
      ...
      <section className="md:px-40 p-10 md:py-20 ibm place-items-center bg-blue-50">
        ...
        <div className="md:flex md:text-sm text-xs mx-auto place-content-stretch text-center py-5">
          <div className="bg-white px-10 py-5 mx-auto mt-1 rounded-lg ">
            <h1 className="mt-2">드론 작동법</h1>
          </div>
          <div className="bg-white px-10 py-5 mx-auto mt-1 rounded-lg ">
            <h1 className="mt-2">자동차 동작법 </h1>
          </div>
          <div className="bg-white px-10 py-5  mx-auto mt-1 rounded-lg">
            <h1 className="mt-2">선박 작동법</h1>
          </div>
        </div>
      </section>
